...
MODEL_SAVE_PATH = "outputs/unet_mask_denoiser_v2.pth" 
...
class UNetMasker(nn.Module):
    def __init__(self):
        ...
        self.bn_d4 = nn.BatchNorm2d(96)                             # BatchNorm for dec4
    ...
    def forward(self, x):
        ...
        e4 = F.leaky_relu(self.bn_e4(self.enc4(e3)), 0.2)          # encoder stage
